package com.labour.lar.keepalive.service;
...
import com.labour.lar.keepalive.config.NotificationUtils;
import com.labour.lar.keepalive.receiver.NotificationClickReceiver;
import com.labour.lar.keepalive.utils.ServiceUtils;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {//android 7.0
                ...
                builder.setOverrideDeadline(JobInfo.DEFAULT_INITIAL_BACKOFF_MILLIS);  //执行的最长延时时间 设置任务最晚的延迟时间
