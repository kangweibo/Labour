...
public abstract class BaseCircleDialog extends DialogFragment {
    ...
    public void  setCreateViewBackground(View view){
        view.setBackgroundResource(R.drawable.dialog_bg_corner);
    }
    public void setCreateViewStyle(){
        setStyle(STYLE_NO_FRAME, R.style.BaseCircleDialog);
    }
    ...
    protected int mRadius = CircleDimen.RADIUS;//对话框的圆角半径
