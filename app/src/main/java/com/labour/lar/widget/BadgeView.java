 ...
 * `DemoActivity` class for more custom badge examples, including 
 * custom backgrounds and animations. `BadgeView` is a subclass of `TextView` 
 * so you can use all of `TextView`'s methods to style 
 * the appearance of your badge.
 * @author Jeff Gilfelt
 */
